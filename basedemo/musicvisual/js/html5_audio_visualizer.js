...
Visualizer.prototype = {
  ...
  _addEventListner: async function () {
    var that = this,
      audioInput = document.getElementById("uploadedFile"),
      dropContainer = document.getElementsByTagName("canvas")[0];
    // const url =
    //   "https://github.com/yuanguandong/resources/blob/master/mp3/%E5%A4%9C%E6%9B%B2.mp3?raw=true";
  ...
  _drawSpectrum: function (analyser) {
    var that = this,
      ...
      capHeight = 2,
      capStyle = "#fff",
      meterNum = cwidth / (meterWidth + 2), //count of the meters
    ...
    var drawMeter = function () {
      ...
      for (var i = 0; i < meterNum; i++) {
        ...
        if (value < capYPositionArray[i]) {
          ...
          ctx.fillRect(i * that.gap, cheight - value, meterWidth, capHeight);
          capYPositionArray[i] = value;
        }
        ctx.fillStyle = gradient; //set the filllStyle to gradient for a better look
        ctx.fillRect(
          i * that.gap /*meterWidth+gap*/,
