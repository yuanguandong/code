  ...
  onBeforeCompile(shader, ...args) {
    ...
    shader.fragmentShader = shader.fragmentShader.replace(
      '#include <emissivemap_fragment>',
          ...
          vec3 reflectionColor = newMerge.rgb * mixStrength;
          float reflectionFactor = min(1.0, mirror);
          
          // 应用颜色混合
          diffuseColor.rgb = baseColor * (1.0 - reflectionFactor) + reflectionColor * reflectionFactor;
          // 保持原始材质的透明度
